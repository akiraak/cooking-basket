...
## 機能開発
- [ ] ローカルサーバに接続する開発アプリの場合は右上ハンバーグのメニューにローカルサーバに接続するのが分かる表示を入れる [plan](docs/plans/mobile-dev-server-indicator.md)
  - [x] Phase 1: `isLocalServer` 判定ヘルパとテスト追加
  - [ ] Phase 2: ハンバーガーメニューとアイコンバッジに反映
